          ...
          {questionsData.map((question) => (
            <div>
              <ListItem>
                ...
                <div>
                  <ListItemText primary={question.question} secondary={["Subject: " + question.subject, "Type: " + question.type, question.company ? "Company: " + question.companies[0] : null].filter(Boolean).join(" | ")} />
