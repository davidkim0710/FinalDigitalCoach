          ...
          {questionsData.map((question) => (
            <div>
              <ListItem>
                ...
                <div>
                  <ListItemText primary={question.question} secondary={["Subject: " + question.subject, "Type: " + question.type, question.companies && questions.companies.length > 0 && questions.companies[0] ? "Company: " + question.companies[0] : null].filter(Boolean).join(" | ")} />
